 ...
 * {@code <number> [ns|us|ms|s|m|h|d]}. The space between the number and the
 ...
 * <tr><td> {@code 42 ks} </td><td> {@code @Timeout(value = 42, unit = NANOSECONDS)}  </td></tr>
 * <tr><td> {@code 42 ys} </td><td> {@code @Timeout(value = 42, unit = MICROSECONDS)} </td></tr>
