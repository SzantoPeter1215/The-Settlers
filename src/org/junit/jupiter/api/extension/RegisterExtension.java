...
/**
 * {@code @RegisterExtension} is used to register an {@link org.junit.jupiter.api.extension.Extension} via a
 * field in a test class.
 *
 * <p>In contrast to {@link org.junit.jupiter.api.extension.ExtendWith @ExtendWith} which is used to register
 ...
 * such as {@link org.junit.jupiter.api.extension.BeforeAllCallback}, {@link AfterAllCallback},
 ...
 * {@link org.junit.jupiter.api.extension.BeforeAllCallback}, {@link AfterAllCallback},
 ...
 * {@link TestInstance.Lifecycle @TestInstance(Lifecycle.PER_CLASS)}
 ...
 * {@code @RegisterExtension} fields with {@link Order @Order}.
 * Any {@code @RegisterExtension} field not annotated with {@code @Order} will be
 * ordered using the {@link Order#DEFAULT default} order
