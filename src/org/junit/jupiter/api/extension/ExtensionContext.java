...
public interface ExtensionContext {
	 ...
	 * that are instances of {@link Store.CloseableResource} are
	...
	interface Store {
		 ...
		 * further details.
		 *
		 * <p>If {@code type} implements {@link CloseableResource}
		 ...
		 *
		 * <p>If the created value is an instance of {@link CloseableResource}
		 * the {@code close()} method will be invoked on the stored object when
		 * the store is closed.
		 *
		 * @param key the key; never {@code null}
		 ...
		 * the {@code key} as input), stored, and returned.
		 *
		 * <p>If {@code requiredType} implements {@link CloseableResource}
		 * the {@code close()} method will be invoked on the stored object when
		 * the store is closed.
		 *
		 * @param key the key; never {@code null}
		 ...
		 * overwrite it.
		 *
		 * <p>If the {@code value} is an instance of {@link CloseableResource}
		 * the {@code close()} method will be invoked on the stored object when
		 * the store is closed.
		 *
