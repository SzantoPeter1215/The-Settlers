...
/**
 * {@code ParameterResolver} defines the API for {@link org.junit.jupiter.api.extension.Extension Extensions}
 * that wish to dynamically resolve arguments for {@linkplain Parameter parameters}
 * at runtime.
 *
 * <p>If a constructor for a test class or a
 * {@link Test @Test},
 * {@link BeforeEach @BeforeEach},
 * {@link AfterEach @AfterEach},
 * {@link BeforeAll @BeforeAll}, or
 * {@link AfterAll @AfterAll} method declares a parameter,
