 ...
 * {@link org.junit.jupiter.api.extension.Extension Extensions} that wish to provide one or multiple contexts
 * for the invocation of a
 * {@link TestTemplate @TestTemplate} method.
 *
...
public interface TestTemplateInvocationContextProvider extends Extension {
	 ...
	 * previously returned {@code true} for the same {@link org.junit.jupiter.api.extension.ExtensionContext};
